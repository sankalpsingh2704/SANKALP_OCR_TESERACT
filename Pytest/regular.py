...
invoiceid = Invoice.InvoiceID(cid,subject);
#print("Step 2");
...
pan = Invoice.PAN(cid,subject);
p = pan.PredictPAN();
#print("pan");
#print(p);


gstin = Invoice.GSTIN(cid,subject);
...
po = Invoice.PONumber(cid,subject);
vpo = po.PredictPO();
#print("po");
#print(vpo);
...
dat = Invoice.InvoiceDate(cid,subject);
da = dat.PredictDate();
#print("date");
#print(da);
...
amount = Invoice.Amount(cid,subject);
