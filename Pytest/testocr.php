<?php
  ...
  file_put_contents($downloadfile, implode("\n", $rows));
	...
	//print_r($nameslist);
	$blacklist = array("INVOICE","TAX","PRIVATE","LIMITED","VENDOR","PACKAGING","GREEN","FICUS","CUM","CHALLAN","&","TIRUMALA","PVT","LTD","SYSTEMS","AO","WORKS","TIMBER","INDUSTRIES","SHEET","CORPORATION","ANEKAL");
